                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-4 sm:p-6 hover:border-orange-500/50 transition-all duration-300">
                        <div class="flex items-start gap-3 sm:gap-4 mb-4">
                            <div class="relative flex-shrink-0">
                                <img src="/placeholder.svg?height=80&width=80" alt="Coach Photo" class="rounded-full w-16 h-16 sm:w-20 sm:h-20 border-4 border-slate-700">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="font-bold text-lg sm:text-xl text-white mb-1 truncate">John Doe</h3>
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <span class="text-slate-300 text-xs sm:text-sm">4.8/5 (24 avis)</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <a href="coach.detail.php" class="w-full bg-gradient-to-br from-orange-500 to-orange-600 hover:shadow-lg hover:shadow-orange-500/20 text-white font-semibold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2 text-sm sm:text-base">
                    ...
                    <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-4 sm:p-6 hover:border-orange-500/50 transition-all duration-300">
                        <div class="flex items-start gap-3 sm:gap-4 mb-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="font-bold text-lg sm:text-xl text-white mb-1 truncate">Jane Smith</h3>
                                <p class="text-orange-500 text-xs sm:text-sm font-medium mb-2">Coach de Natation</p>
                                <div class="flex items-center gap-1">
                                    <svg class="w-4 h-4 text-orange-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                    <span class="text-slate-300 text-xs sm:text-sm">4.9/5 (31 avis)</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <button class="w-full bg-gradient-to-br from-orange-500 to-orange-600 hover:shadow-lg hover:shadow-orange-500/20 text-white font-semibold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2 text-sm sm:text-base">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                            </svg>
                    ...
                    <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-4 sm:p-6 hover:border-orange-500/50 transition-all duration-300">
                        <div class="flex items-start gap-3 sm:gap-4 mb-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="font-bold text-lg sm:text-xl text-white mb-1 truncate">Mike Brown</h3>
                                <p class="text-orange-500 text-xs sm:text-sm font-medium mb-2">Coach de Fitness</p>
                                <div class="flex items-center gap-1">
                                    <svg class="w-4 h-4 text-orange-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                    <span class="text-slate-300 text-xs sm:text-sm">4.7/5 (19 avis)</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-4 sm:p-6 hover:border-orange-500/50 transition-all duration-300">
                        <div class="flex items-start gap-3 sm:gap-4 mb-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="font-bold text-lg sm:text-xl text-white mb-1 truncate">Sarah Johnson</h3>
                                <p class="text-orange-500 text-xs sm:text-sm font-medium mb-2">Coach de Yoga</p>
                                <div class="flex items-center gap-1">
                                    <svg class="w-4 h-4 text-orange-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                    <span class="text-slate-300 text-xs sm:text-sm">5.0/5 (42 avis)</span>
                                </div>
                            </div>
                        </div>
