...
<body class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <nav class="absolute top-0 left-0 right-0 z-10 p-4 md:p-6">
            ...
            <div id="mobileMenu" class="hidden md:hidden mt-4 bg-slate-800/95 backdrop-blur-sm rounded-lg border border-white/10 overflow-hidden">
                <a href="auth/login.php" class="block px-6 py-3 text-white hover:bg-white/10 transition-colors duration-200 font-medium border-b border-white/10">
                    Se connecter
                </a>
                <a href="auth/register.php" class="block px-6 py-3 text-orange-400 hover:bg-white/10 transition-colors duration-200 font-medium">
                    Créer un compte
                </a>
            </div>
        </nav>
        ...
        <div class="flex-1 flex items-center justify-center px-4 sm:px-6 py-24 md:py-20">
            <div class="max-w-5xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 md:gap-4 mb-12 md:mb-16 px-4">
                    <a href="auth/register.php" class="px-6 md:px-8 py-3 md:py-4 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-all duration-200 font-semibold text-base md:text-lg shadow-xl shadow-orange-500/30 w-full sm:w-auto text-center">
                        Commencer maintenant
                    </a>
                    <a href="auth/login.php" class="px-6 md:px-8 py-3 md:py-4 bg-white/10 backdrop-blur-sm text-white rounded-lg hover:bg-white/20 transition-all duration-200 font-semibold text-base md:text-lg border border-white/20 w-full sm:w-auto text-center">
                        J'ai déjà un compte
                    </a>
                </div>
    ...
    <script>
        ...
        const mobileMenuBtnIndex = document.getElementById('mobileMenuBtn');
        const mobileMenuIndex = document.getElementById('mobileMenu');

        mobileMenuBtnIndex.addEventListener('click', () => {
